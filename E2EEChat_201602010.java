    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                if (newMessage[0].equals("3EPROTO")) {
                    if (newMessage[1].equals("CONNECT") || newMessage[1].equals("DISCONNECT")) {
                        message = message + '\n' + scanner.nextLine().trim();
                    }
                    if (newMessage[1].equals("KEYXCHG")) {
                        message = message + '\n' + scanner.nextLine().trim();
                        message = message + '\n' + scanner.nextLine().trim();
                        message = message + '\n' + scanner.nextLine().trim();
                        scanner.nextLine();
                    ...
                    if (newMessage[1].equals("MSGSEND")) {
                        message = message + '\n' + scanner.nextLine().trim();
                        message = message + '\n' + scanner.nextLine().trim();
                        message = message + '\n' + scanner.nextLine().trim();
                        scanner.nextLine();
